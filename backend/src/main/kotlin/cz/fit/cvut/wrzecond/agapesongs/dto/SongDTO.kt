...
data class SongReadDTO (override val id: Int, val songBook: SongBookReadDTO, val name: String,
                        val text: List<SongLineReadDTO>, val key: SongKey, val bpm: Int, val capo: Int,
                        val lastEdit: Timestamp, val displayId: Int?, val note: SongNoteReadDTO?) : IReadDTO
 ...
 */
data class SongCreateDTO (val name: String, val text: String, val key: SongKey, val bpm: Int,
 ...
 */
data class SongUpdateDTO (val name: String?, val text: String?, val key: SongKey?, val bpm: Int?,
