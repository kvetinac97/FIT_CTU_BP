...
final class BandViewModelTests: AgapeSongsTestCase {
    ...
    private static let dummyBand = Band(id: 1, name: "", members: [])
    ...
    private func setUpViewModel() {
        band = Binding<Band>(
            get: { [weak self] in self?.wrappedBand ?? BandViewModelTests.dummyBand },
